...
proc create_hier_cell_RealFFT { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_RealFFT() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net axis_subset_converter_0_M_AXIS [get_bd_intf_pins realfft_m_axis_dout] [get_bd_intf_pins axis_subset_converter_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net hls_xfft2real_0_dout [get_bd_intf_pins axis_subset_converter_0/S_AXIS] [get_bd_intf_pins hls_xfft2real_0/dout]
  ...
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins hls_real2xfft_0/ap_clk] [get_bd_pins hls_xfft2real_0/ap_clk] [get_bd_pins xfft_0/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins hls_real2xfft_0/ap_rst_n] [get_bd_pins hls_xfft2real_0/ap_rst_n] [get_bd_pins xfft_0/aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net RealFFT_realfft_m_axis_dout [get_bd_intf_pins RealFFT/realfft_m_axis_dout] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net S01_AXI_1 [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins ps7_0_axi_periph/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins RealFFT/realfft_s_axis_din] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
