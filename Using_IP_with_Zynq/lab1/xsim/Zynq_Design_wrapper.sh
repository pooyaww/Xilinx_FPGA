...
#
# Filename    : Zynq_Design_wrapper.sh
...
#
# Generated by Vivado on Fri Jan 04 17:10:59 CET 2019
# SW Build 2086221 on Fri Dec 15 20:54:30 MST 2017
#
# Copyright 1986-2017 Xilinx, Inc. All Rights Reserved. 
#
# usage: Zynq_Design_wrapper.sh [-help]
# usage: Zynq_Design_wrapper.sh [-lib_map_path]
# usage: Zynq_Design_wrapper.sh [-noclean_files]
# usage: Zynq_Design_wrapper.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "Zynq_Design_wrapper.sh - Script generated by export_simulation (Vivado v2017.4 (64-bit)-id)\n"
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./Zynq_Design_wrapper.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Zynq_Design_wrapper.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./Zynq_Design_wrapper.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: Zynq_Design_wrapper.sh [-help]\n\
Usage: Zynq_Design_wrapper.sh [-lib_map_path]\n\
Usage: Zynq_Design_wrapper.sh [-reset_run]\n\
Usage: Zynq_Design_wrapper.sh [-noclean_files]\n\n\
