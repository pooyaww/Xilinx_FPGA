...
HD_PWD='C:/zcu106_ipi/zcu106_ipi.runs/system_gt_freq_counter_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_gt_freq_counter_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_gt_freq_counter_2_0.tcl
