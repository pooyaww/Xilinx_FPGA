...
HD_PWD='C:/zcu106_ipi/zcu106_ipi.runs/system_FMC_HPC0_CLK0_M2C_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_FMC_HPC0_CLK0_M2C_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_FMC_HPC0_CLK0_M2C_0.tcl
