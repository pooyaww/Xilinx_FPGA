...
set rc [catch {
  ...
  add_files -quiet C:/zcu106_ipi/zcu106_ipi.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/zcu106_ipi/zcu106_ipi.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/zcu106_ipi/zcu106_ipi.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/zcu106_ipi/zcu106_ipi.srcs/constrs_1/new/system.xdc
  set_param project.isImplRun true
  link_design -top system_wrapper -part xczu7ev-ffvc1156-2-i-es2
  set_param project.isImplRun false
