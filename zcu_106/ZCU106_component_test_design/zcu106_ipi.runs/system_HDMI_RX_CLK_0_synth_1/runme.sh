...
HD_PWD='C:/zcu106_ipi/zcu106_ipi.runs/system_HDMI_RX_CLK_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_HDMI_RX_CLK_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_HDMI_RX_CLK_0.tcl
