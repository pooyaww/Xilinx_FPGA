...
HD_PWD='C:/zcu106_ipi/zcu106_ipi.runs/system_system_management_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_system_management_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_system_management_wiz_0_0.tcl
