...
HD_PWD='C:/zcu106_ipi/zcu106_ipi.runs/system_USER_MGT_SI570_CLOCK1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_USER_MGT_SI570_CLOCK1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_USER_MGT_SI570_CLOCK1_0.tcl
