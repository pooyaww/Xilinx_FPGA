...
C_SRCS += \
C:/zcu106_ipi/zcu106_ipi.sdk/system_wrapper_hw_platform_0/psu_init.c \
...
src/psu_init.o: C:/zcu106_ipi/zcu106_ipi.sdk/system_wrapper_hw_platform_0/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM v8 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -I"C:\zcu106_ipi\zcu106_ipi.sdk\system_wrapper_hw_platform_0" -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I../../zynq_mp_fsbl_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
