...
--               C:/zcu106_ipi/zcu106_ipi.srcs/sources_1/bd/system/ip/system_gt_freq_counter_0_0/system_gt_freq_counter_0_0_sim_netlist.vhdl
...
entity system_gt_freq_counter_0_0_gt_freq_counter is
  port (
  ...
  attribute ORIG_REF_NAME of system_gt_freq_counter_0_0_gt_freq_counter : entity is "gt_freq_counter";
end system_gt_freq_counter_0_0_gt_freq_counter;

architecture STRUCTURE of system_gt_freq_counter_0_0_gt_freq_counter is
  signal DIFF_MGTE4_bufg : STD_LOGIC;
  signal DIFF_MGTE4_out : STD_LOGIC;
  ...
  signal NLW_IBUFDS_GTE4_inst_DIFF_MGTE4_CLK1_O_UNCONNECTED : STD_LOGIC;
  ...
  attribute BOX_TYPE of BUFG_GT_inst_DIFF_MGTE4_CLK1 : label is "PRIMITIVE";
  ...
  attribute BOX_TYPE of IBUFDS_GTE4_inst_DIFF_MGTE4_CLK1 : label is "PRIMITIVE";
...
BUFG_GT_inst_DIFF_MGTE4_CLK1: unisim.vcomponents.BUFG_GT
     port map (
      CE => \xlnx_opt_\,
      CEMASK => '0',
      CLR => \xlnx_opt__1\,
...
IBUFDS_GTE4_inst_DIFF_MGTE4_CLK1: unisim.vcomponents.IBUFDS_GTE4
    generic map(
      REFCLK_EN_TX_PATH => '0',
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_gt_freq_counter_0_0 is
  port (
    FREQ_CNT_O : out STD_LOGIC_VECTOR ( 15 downto 0 );
    RST_I : in STD_LOGIC;
    REF_CLK_I : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of system_gt_freq_counter_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_gt_freq_counter_0_0 : entity is "system_gt_freq_counter_0_0,gt_freq_counter,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_gt_freq_counter_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_gt_freq_counter_0_0 : entity is "gt_freq_counter,Vivado 2018.2";
end system_gt_freq_counter_0_0;

architecture STRUCTURE of system_gt_freq_counter_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of DIFF_MGTE4_N : signal is "xilinx.com:interface:diff_clock:1.0 DIFF_GT_CLK CLK_N";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of DIFF_MGTE4_N : signal is "XIL_INTERFACENAME DIFF_GT_CLK, CAN_DEBUG false, FREQ_HZ 100000000";
  attribute X_INTERFACE_INFO of DIFF_MGTE4_P : signal is "xilinx.com:interface:diff_clock:1.0 DIFF_GT_CLK CLK_P";
...
begin
inst: entity work.system_gt_freq_counter_0_0_gt_freq_counter
     port map (
