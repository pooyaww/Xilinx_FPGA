...
#
# Generated by export_simulation on Fri Jan 04 17:10:59 CET 2019
#
################################################################################
...
'-reset_run' switch to the './Zynq_Design_wrapper.sh' script.

./Zynq_Design_wrapper.sh -reset_run
...
./Zynq_Design_wrapper.sh -noclean_files

For more information on the script, please type './Zynq_Design_wrapper.sh -help'.
