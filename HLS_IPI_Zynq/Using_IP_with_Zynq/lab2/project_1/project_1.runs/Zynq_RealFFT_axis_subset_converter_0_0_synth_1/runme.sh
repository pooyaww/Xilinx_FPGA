...
HD_PWD='/home/puya/Projects/FPGA/Xilinx/HLS/Vivado_HLS_Tutorial/Using_IP_with_Zynq/lab2/project_1/project_1.runs/Zynq_RealFFT_axis_subset_converter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Zynq_RealFFT_axis_subset_converter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Zynq_RealFFT_axis_subset_converter_0_0.tcl
