...
HD_PWD='/home/puya/Projects/FPGA/Xilinx/HLS/Vivado_HLS_Tutorial/Using_IP_with_IPI/lab1/project_1/project_1.runs/RealFFT_hls_xfft2real_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RealFFT_hls_xfft2real_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RealFFT_hls_xfft2real_0_0.tcl
