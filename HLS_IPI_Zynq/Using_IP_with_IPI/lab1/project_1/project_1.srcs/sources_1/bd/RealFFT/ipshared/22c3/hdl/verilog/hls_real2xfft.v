...
(* CORE_GENERATION_INFO="hls_real2xfft,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.890000,HLS_SYN_LAT=520,HLS_SYN_TPT=512,HLS_SYN_MEM=6,HLS_SYN_DSP=2,HLS_SYN_FF=630,HLS_SYN_LUT=1259}" *)
...
wire    Loop_sliding_win_del_U0_din_V_V_read;
...
wire   [32:0] Loop_real2xfft_outpu_U0_dout_V_din;
wire    Loop_real2xfft_outpu_U0_dout_V_write;
...
Loop_sliding_win_del Loop_sliding_win_del_U0(
    ...
    .din_V_V_dout(din_V_V_dout),
    .din_V_V_empty_n(din_V_V_empty_n),
    .din_V_V_read(Loop_sliding_win_del_U0_din_V_V_read),
...
Loop_real2xfft_outpu Loop_real2xfft_outpu_U0(
    ...
    .dout_V_din(Loop_real2xfft_outpu_U0_dout_V_din),
    .dout_V_full_n(dout_V_full_n),
    .dout_V_write(Loop_real2xfft_outpu_U0_dout_V_write)
);
...
assign din_V_V_read = Loop_sliding_win_del_U0_din_V_V_read;

assign dout_V_din = Loop_real2xfft_outpu_U0_dout_V_din;

assign dout_V_write = Loop_real2xfft_outpu_U0_dout_V_write;
