...
module hls_real2xfft_s_axis_din_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    input  wire        TVALID,
    ...
    // User signals
    output wire [15:0] din_V_V_dout,
    output wire        din_V_V_empty_n,
    input  wire        din_V_V_read
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_write;
...
//------------------------Instantiation------------------
// rs
hls_real2xfft_s_axis_din_reg_slice #(
    .N       ( 16 )
) rs (
    .clk     ( ACLK ),
    .reset   ( ARESETN ),
...
// din_V_V_fifo
hls_real2xfft_s_axis_din_fifo #(
    .DATA_BITS  ( 16 ),
    .DEPTH_BITS ( 4 )
) din_V_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( din_V_V_empty_n ),
    .full_n     ( din_V_V_full_n ),
    .read       ( din_V_V_read ),
    .write      ( fifo_write ),
    .dout       ( din_V_V_dout ),
    .din        ( din_V_V_din )
...
assign din_V_V_din = m_data[15:0];
assign fifo_full_n = din_V_V_full_n;
