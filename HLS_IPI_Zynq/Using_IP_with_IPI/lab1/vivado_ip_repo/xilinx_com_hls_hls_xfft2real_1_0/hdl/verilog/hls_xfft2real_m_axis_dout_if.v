...
module hls_xfft2real_m_axis_dout_if (
    // AXI4-Stream singals
    input  wire        ACLK,
    input  wire        ARESETN,
    output wire        TVALID,
    ...
    // User signals
    input  wire [31:0] dout_V_din,
    output wire        dout_V_full_n,
    input  wire        dout_V_write
);
//------------------------Local signal-------------------
// FIFO
wire [0:0]  fifo_read;
...
// dout_V_fifo
hls_xfft2real_m_axis_dout_fifo #(
    .DATA_BITS  ( 32 ),
    .DEPTH_BITS ( 4 )
) dout_V_fifo (
    .clk        ( ACLK ),
    .aclr       ( ~ARESETN ),
    .empty_n    ( dout_V_empty_n ),
    .full_n     ( dout_V_full_n ),
    .read       ( fifo_read ),
    .write      ( dout_V_write ),
    .dout       ( dout_V_dout ),
    .din        ( dout_V_din )
...
assign s_data  = {dout_V_dout};

//+++++++++++++++++++++++++++++++++++++++++++++++++++++++

//++++++++++++++++++++++++FIFO+++++++++++++++++++++++++++
assign fifo_read    = fifo_empty_n & s_ready;
assign fifo_empty_n = dout_V_empty_n;
...
module hls_xfft2real_m_axis_dout_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH_BITS = 4
)(
...
module hls_xfft2real_m_axis_dout_reg_slice
#(parameter
    N = 8   // data width
) (
    // system signals
